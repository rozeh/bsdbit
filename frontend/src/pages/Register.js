...
const RegisterBlock = styled.div`
  ...
  /* join_form scroll */
  .join_form .agree_box::-webkit-scrollbar {
    width: 6px;
  }

  .join_form .agree_box::-webkit-scrollbar-thumb {
    background-color: #5775d9;
  }

  .join_form .agree_box::-webkit-scrollbar-thumb:hover {
    background-color: #526296;
  }

  .join_form .agree_box::-webkit-scrollbar-track {
